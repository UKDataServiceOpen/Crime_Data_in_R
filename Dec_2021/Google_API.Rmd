...
1. https://console.cloud.google.com/apis/dashboard?project=missing-314119
2. Click '+ Enable APIS and SERVICES' at the top of the screen
3. Search for each API listed above and click the 'Enable button' 

One all are enabled, wait 5 minutes for changes to take place, and then move on to the next step to register your API to google. 
