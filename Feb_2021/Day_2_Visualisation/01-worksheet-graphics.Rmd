---
title: "Data visualisation in R: graphics"
author: "Sam Langton"
...
This workshop focuses on the practicalities of creating data visualisations in R. Unfortunately, being able to code and generate visualisations in R is only part of the challenge! While the skills we learn today will help you structure your thinking around creating powerful and accessible visuals, I would recommend you also explore some of the additional resources at the end of this worksheet. We love R, but being open to reading non-R related resources on data visualisation will be a key part of the learning process. For now, let's get going with some R :)
...
```{r, echo=FALSE, out.width = "300px", fig.align= "center", fig.cap="Source: [Skill Gaze](https://skillgaze.com/2017/10/31/understanding-different-visualization-layers-of-ggplot/)"}
...
```{r, echo=FALSE, out.width="900px", fig.align= "center", message=F, warning=F}
knitr::include_graphics("img/cow_example2.png")
```
...
```{r}
ggsave(plot = p1, path = "visuals", filename = "my_plot.png", device = "png", width = 16, height = 12, units = "cm",
       dpi = 100)
```
